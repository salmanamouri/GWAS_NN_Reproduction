...
## Reproduction layer
This repository now includes a `repro/` directory containing a paper-faithful simulation and evaluation pipeline for Figures 2–5, excluding the restricted-data UK Biobank and FINRISK experiments.