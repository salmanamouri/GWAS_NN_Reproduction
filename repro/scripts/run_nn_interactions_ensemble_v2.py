...
def main():
    out_dir = Path("repro/outputs/nn_ensemble_v2")
    ...
    with open(out_dir / "nn_ensemble_v2_results.json", "w", encoding="utf-8") as f:
        json.dump(results, f, indent=2)

    print("Ensemble V2 NN interaction metrics:", metrics)
