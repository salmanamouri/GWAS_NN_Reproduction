# """run_permutation.py trains a main-effect model, permutes residuals, rebuilds the target, retrains the interaction model, and saves permutation results under PermutationDistribution/. That is Perm I behavior."""
